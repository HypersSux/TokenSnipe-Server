...
if (DISCORD_TOKEN && DISCORD_GUILD && DISCORD_ROLE) {
  ...
  const commands = [
    new SlashCommandBuilder()
      ...
      .addStringOption(o => o
        .setName('duration')
        .setDescription('How long should the key last?')
        .setRequired(false)
        .addChoices(
          { name: '1 hour',    value: 'h1'   },
          { name: '2 hours',   value: 'h2'   },
          { name: '3 hours',   value: 'h3'   },
          { name: '6 hours',   value: 'h6'   },
          { name: '12 hours',  value: 'h12'  },
          { name: '18 hours',  value: 'h18'  },
          { name: '23 hours',  value: 'h23'  },
          { name: '1 day',     value: 'd1'   },
          { name: '3 days',    value: 'd3'   },
          { name: '7 days',    value: 'd7'   },
          { name: '14 days',   value: 'd14'  },
          { name: '30 days',   value: 'd30'  },
          { name: '1 month',   value: 'm1'   },
          { name: '2 months',  value: 'm2'   },
          { name: '3 months',  value: 'm3'   },
          { name: '6 months',  value: 'm6'   },
          { name: '12 months', value: 'm12'  },
...
<div id="app">
  ...
  <div class="main">
    ...
    <!-- Create key — superadmin AND panel users -->
          ...
          <div class="field">
            ...
            <select id="c-days">
              <optgroup label="Hours">
                ...
                <option value="h18">18 hours</option>
                <option value="h23">23 hours</option>
              </optgroup>
              <optgroup label="Days">
...
function showApp(){
  ...
  document.getElementById('create-key-card').style.display='block';
...
async function createKey(){
  ...
  const duration=document.getElementById('c-days').value;
  ...
  if(data.key){
    ...
    copyText(data.key);
    toast('Key created + copied! (' + (data.duration||'Lifetime') + ')','ok');
